...
def test_propert_for_construction():
    property = Property(4, "Sunny Shack", 
                    True, 
                    "£5.99", 
                    "example@example.com", 
                    "012347656894",
...
def test_variables_equal_themselves():
    property1 = Property(4, "Sunny Shack", 
                    True, 
                    "£5.99", 
                    "example@example.com", 
                    "012347656894",
    ...
    property2 = Property(4, "Sunny Shack", 
                    True, 
                    "£5.99", 
                    "example@example.com", 
                    "012347656894",
...
def test_property_formats_nicely():
    property1 = Property(4, "Sunny Shack", 
                    ...
                    "This is a wonderful sunny spot in the heart of Sunny Town", 
                    32)
    assert str(property1) == "Property(4, Sunny Shack, True, £5.99, example@example.com, 012347656894, 4 Sunny Street, Sunny Town, SU00 SU2, This is a wonderful sunny spot in the heart of Sunny Town, 32)"
